...
class SubscriptionManager(
    ...
    val subscriptionStatus: Flow<SubscriptionStatus> = combine(
        ...
        val effectiveTier = when {
            com.leadshield.app.BuildConfig.SUBSCRIPTION_TIER == 5 -> SubscriptionTier.TEAM
            com.leadshield.app.BuildConfig.SUBSCRIPTION_TIER == 4 -> SubscriptionTier.VOICE
            com.leadshield.app.BuildConfig.SUBSCRIPTION_TIER == 3 -> SubscriptionTier.MASTER
    ...
    init {
        ...
        when (com.leadshield.app.BuildConfig.SUBSCRIPTION_TIER) {
